  ...
  return (
    ...
    <div className="mx-auto w-full p-6 lg:p-8">
      <div className="mx-auto max-w-2xl lg:mx-0">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">Meet the people who work in Dahl Lab</p>
      </div>
      <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          ...
          <a href="#" className="group relative block h-64 sm:h-80 lg:h-96">
            ...
            >
              ...
              >
                <h3 className="mt-4 text-xl font-medium sm:text-2xl">John Dahl</h3>
            
                <p className="mt-4 text-sm sm:text-base">
                Associate Professor at the University of Minnesota Duluth, holding a Ph.D. in Microbiology from the University of Virginia and having completed a postdoctoral fellowship at the University of Arizona. Authored several peer-reviewed publications on microbiology and infectious diseases, and taught advanced courses such as Medical Microbiology, Molecular Biology, and Global Infectious Diseases at multiple institutions.
                </p>
